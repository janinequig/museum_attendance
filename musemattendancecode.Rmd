...
subdata = data %>% select(Race, Sex, Age, Region, LaborForce, CitySize, CitizenshipStatus, MaritalStatus, FamilyIncome, Education, VisitMuseum, NumMuseumVisit, ArtsOrgSubscribe, PurchaseArt)
...
subdata2 = data %>% select(Race, Sex, Age, Region, LaborForce, CitySize, ArtsInfo, ArtsOpportunity, CitizenshipStatus, MaritalStatus, FamilyIncome, Education, VisitMuseum, NumMuseumVisit, ArtsOrgSubscribe, PurchaseArt) 
  # removed Student, WrkHrsRange, and WeeklyHrsWrk - left with 807 x 16
data16 = na.omit(subdata2)

subdata3 = data %>% select(Race, Sex, Age, Region, LaborForce, CitySize, ArtsInfo, ArtsOpportunity, WrkHrsRange, WeeklyHrsWrk, CitizenshipStatus, MaritalStatus, FamilyIncome, Education, VisitMuseum, NumMuseumVisit, ArtsOrgSubscribe, PurchaseArt)
na.omit(subdata3) 
